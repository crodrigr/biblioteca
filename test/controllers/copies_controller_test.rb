...
class CopiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create copy" do
    assert_difference('Copy.count') do
      post copies_url, params: { copy: { codigo: @copy.codigo, localizacion: @copy.localizacion } }
    end
  ...
  test "should update copy" do
    patch copy_url(@copy), params: { copy: { codigo: @copy.codigo, localizacion: @copy.localizacion } }
